...
class ShadowFormer(nn.Module):
    ...
    def forward(self, x, xm, mask=None):
        # Input  Projection
        xm = xm.max(dim=1).values.unsqueeze(1)
        #torchvision.utils.save_image(xm[1],"/home/ubuntu/axproject/Flare7K/vis/xm1.png")
        #torchvision.utils.save_image(xm[0],"/home/ubuntu/axproject/Flare7K/vis/xm0.png")
