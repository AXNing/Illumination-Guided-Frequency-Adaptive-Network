...
def predict_flare_from_6_channel(input_tensor,gamma):
    ...
    #torchvision.utils.save_image(deflare_img[0],"/home/ubuntu/axproject/Flare7K/vis/deflare1.png")
    flare_img_predicted=input_tensor[:,3:,:,:]
    #torchvision.utils.save_image(flare_img_predicted[0],"/home/ubuntu/axproject/Flare7K/vis/flare_img_predicted1.png")
    ...
    #torchvision.utils.save_image(merge_img_predicted[0],"/home/ubuntu/axproject/Flare7K/vis/merge_img_predicted1.png")
...
def predict_flare_from_3_channel(input_tensor,flare_mask,base_img,flare_img,merge_img,gamma):
    ...
    #print(merge_tensor_linear-input_tensor_linear)
    ...
    #torchvision.utils.save_image(masked_flare_img_predicted[0],"/home/ubuntu/axproject/Flare7K/vis/masked_flare_img_predicted.png")
